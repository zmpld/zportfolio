const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M13.5 9H15.5V6.5H13.5C11.567 6.5 10 8.067 10 10V12H8V14.5H10V21H12.5V14.5H15L15.5 12H12.5V10C12.5 9.448 12.948 9 13.5 9Z"
          fill="currentColor"
        />
      </svg>
    ),
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://forminit.com/f/5vmnje7cglw"
          method="POST"
          className="xl:pl-10 2xl:pl-20"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              <label htmlFor="fi-sender-fullName" className="label reveal-up">
                Name
              </label>
              <input
                type="text"
                ...
                id="name"
                autoComplete="fi-sender-fullName"
                required
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="email"
                autoComplete="fi-sender-email"
                required
                placeholder="zmapalad@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
